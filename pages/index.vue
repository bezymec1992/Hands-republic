<template>
	<div class="home-page">
			...
			<div class="container">
				<div class="intro-main flex-column-reverse flex-lg-row row">
					<div class="intro__title-wrapp col-12 col-lg-6">
						...
						<Button title="See our brands" class="btn-dark-outline-title" :has-icon="true" type="nuxt-link" to="/brands" />
					</div>
		...
		<div class="stand-wrapper">
			<div class="container">
				<Stand class="style3" img="img-03.jpg" img-mob="img-04.jpg" title1="Super charging" title2="business performance" :btn="{ title: up_md ? 'About us' : 'Work together', to: 'our-company' }" text="We champion small businesses in the digital world and have over 1,700 localised experts to help you spread your reach." />
			</div>
		</div>
		<Marquee>
		...
		<VisualSection img="img-04.jpg" img-mob="img-05.jpg" title="It’s all about TEAMING" :btn="{ title: up_md ? 'Work together' : 'About us', to: '/working-together' }" />
		...
		<QuoteSection text="To see all the cross-functional teaming that has led to developing exceptional team.blue products and enduring relationships makes me extremely proud." name="Jacob Nijholt" position="Chief Product Owner" img="img-01.jpg" img-mob="img-02.jpg" />
		<ContactSection />
	</div>
</template>
