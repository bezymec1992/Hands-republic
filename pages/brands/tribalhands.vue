<template>
	<div>
		<div class="label-tribalhands">
				...
				<div class="container">
					<div class="flex-column-reverse flex-lg-row row">
						<div class="intro__title-wrapp col-12 col-lg-5">
							<h1 class="h1 intro__title">Tribalhands</h1>
							<div class="intro__text-holder">
						...
						<div class="col-12 col-lg-7">
							<div class="intro-img">
								<picture>
									<source srcset="@/assets/images/img-00026.png" media="(max-width: 991px)" />
									<img src="@/assets/images/img-00027.png" alt="img description" />
								</picture>
							</div>
						</div>
					</div>
			...
			<Marquee> YOUR BEST <br class="d-md-none" /><span>DIGITAL</span> <br class="d-md-none" />TEAM </Marquee>
				...
				<div class="container">
					<div class="row g-0">
						...
						<div class="col-12 col-md-7">
							<picture>
								<source srcset="@/assets/images/img-00032.png" media="(max-width: 992px)" />
								<img src="@/assets/images/img-00033.png" alt="location" />
							</picture>
						</div>
					</div>
				</div>
	...
	data() {
		return {
			stand2: {
				...
				img: "img-00029.png",
				imgMob: "img-00028.png"
			},
			info: {
				title: "We create many types of projects",
				text: " We can build landing page, website,e-commerce, CRM system, platforms and applications ",
				img: "img-00031.png",
				imgMob: "img-00030.png"
			},
			card: {
				title: "Find your special team right now",
				img: "img-00035.png",
				imgMob: "img-00034.png"
			},
			labelsList: []
		};
	},
...
.intro-section {
	...
	&::before {
		@include media-breakpoint-down(lg) {
			...
			width: 100%;
			height: 100%;
			background: radial-gradient(184.53% 59.61% at 84.53% 10.34%, #0548b9 0%, rgba(4, 73, 186, 0) 100%);
		}
	}
